...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/close.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1 data-aos="zoom-in" data-aos-duration="2000">thank you for order</h1>
                    <div class="banner-form"  data-aos="fade-up" data-aos-duration="1500">
                       <a href="restaurants.php" class="btn theme-btn btn-lg custom-button">Back To Menu</a>
