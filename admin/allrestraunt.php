...
if (mysqli_num_rows($query) > 0) {
    while ($rows = mysqli_fetch_array($query)) {
        ...
        <td>
            ...
            <a href="update_restraunt.php?rs_upd=' . $rows['rs_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">
                <i class="ti-settings"></i>
            </a>
        </td>
        </tr>';
        $number++; // Tambahkan nomor setelah menggambar baris
    }
} else {
    echo '<tr><td colspan="3"><center>No Stores Data!</center></td></tr>';
}
