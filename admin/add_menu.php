    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || empty($_POST['price']) || empty($_POST['res_name'])) {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $input_harga = $_POST['price']; // Ambil harga dari input form
                $input_harga = str_replace(',', '', $input_harga); // Hapus tanda koma jika ada
                
                if (is_numeric($input_harga)) {
                    $formatted_harga = number_format($input_harga, 0, ',', '.');
                    $input_harga = $formatted_harga;
                } else {
                ...
                $sql = "INSERT INTO dishes (rs_id, title, slogan, price, img) VALUES ('" . $_POST['res_name'] . "','" . $_POST['d_name'] . "','" . $_POST['about'] . "','" . $input_harga . "','" . $fnew . "')";
                mysqli_query($db, $sql);
                ...
                // Redirect to all_menu.php after successful submission
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" class="form-control" placeholder="Ayam Penyet">
                                                   </div>
                                            </div>
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from restaurant";
													...
													{
                                                       echo' <option value="'.$row['rs_id'].'">'.$row['category'].'</option>';;
													}  
